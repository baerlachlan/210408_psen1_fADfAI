...
```{r}
DAR <- set_names(DAR, c("T428del/+ vs +/+", "W233fs/+ vs +/+"))
...
```{r}
ggsave(
  "~/phd/publications/fisher_pub/figures/supp/window_sizes_zebrafish.png",
  device = "png",
  width = 18,
  height = 6,
  units = "cm"
