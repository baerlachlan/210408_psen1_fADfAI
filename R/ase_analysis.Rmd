...
```{r}
## This code chunk has a lengthy run-time and will not execute if file already exists
## Instead object is saved as Rds and reloaded when needed
if (!file.exists(here("files/fgsea_nd.Rds"))) {
  set.seed(17)
  ranks_nd <- replicate(
    n = 200,
...
## This code chunk has a lengthy run-time and will not execute if file already exists
## Instead object is saved as Rds and reloaded when needed
if (!file.exists(here("files/fgsea_d.Rds"))) {
  set.seed(17)
  ranks_d <- replicate(
    n = 200,
